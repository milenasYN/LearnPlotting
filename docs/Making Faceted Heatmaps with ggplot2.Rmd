...
```
See https://github.com/hrbrmstr/facetedcountryheatmaps/tree/master/Making%20Faceted%20Heatmaps%20with%20ggplot2
...
One of the best ways to visualize these "working hours" is a temporal heatmap. 
...
```{r fig.width=9, fig.height=15, message=FALSE, warning=FALSE}
